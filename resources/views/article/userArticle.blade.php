    ...
    <table class="table table-dark table-striped table-hover">
      ...
      <tbody>
        ...
        @forelse($articles as $article)
          @foreach ($article->articleLanguage as $language)
            <tr>
              <td class="text-center">
                <a href="{{ route('article.show', [$article->id, $language->language->id]) }}" class="text-decoration-none link-light">
                  {{ $language->title }}
                </a>
              </td>
              <td class="text-center">
              ...
              <td class="text-center"><a href="{{ route('article.edit', [$article->id, $language->language->id]) }}"
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <form action="{{ route('article.delete', [$article->id, $language->language_id]) }}" method="post">
                      @csrf
                      @method('delete')
